---
title: "What Is GameLit? The Sub-Genre Every Power Fantasy Reader Should Know"
description: "GameLit is one of the fastest-growing corners of power fantasy fiction. Here's what defines it, why readers love it, and the best gateway books to start with."
date: "2026-06-05"
...
According to community data from [LitRPGTools.com](https://LitRPGTools.com), GameLit titles account for over 40% of all user reading lists tracked on the platform, making it the single most-represented category in the power fantasy reader community. That number has grown by roughly 18% over the last two years, driven almost entirely by [system apocalypse](/rankings/best-system-apocalypse) and dungeon core crossovers.
...
1. **Dungeon Crawler Carl by Matt Dinniman** — The gold standard entry point. Carl and his cat Princess Donut navigate an apocalyptic dungeon game broadcast to an alien audience. It's brutal, funny, and mechanically clever. If you read one GameLit book this year, make it this one. [See it on our rankings](/rankings/top-power-fantasy-books).

2. **He Who Fights With Monsters by Shirtaloon** — A slow-burn [isekai](/rankings/best-isekai-novels) with tight GameLit mechanics and one of the best-developed magic systems in the genre. Jason Asano is an everyman protagonist who grows into genuine power in ways that feel earned. Millions of readers can't be wrong.
