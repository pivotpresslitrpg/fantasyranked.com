---
title: "Sean Oswald and David North in 2026: Where Two of LitRPG's Quietest Heavy Hitters Rank Right Now"
description: "A ranking-focused look at Sean Oswald and David North — two LitRPG authors quietly putting up some of the genre's strongest community ratings. Where each catalog stands, what's new, and how they slot into the broader power fantasy landscape."
date: "2026-05-02"
...
**Why North matters right now.** The crafting subgenre is one of the underserved corners of LitRPG. Most readers who say they want crafting-focused progression discover that a lot of "crafting LitRPG" is actually combat LitRPG with a forge in chapter 14. North is one of the few writers genuinely operating in the crafting-as-core-loop space. If the crafting subgenre keeps growing — and the [LitRPGTools.com](https://litrpgtools.com) reader-engagement data suggests it is — North is positioned to be one of the names readers cite by default.

## How They Rank Against the Broader Field

Putting the two on the same board against [Fantasy Ranked's](/) usual reference points:

1. **Apocalypse BREAKER (Oswald + Renfroe)** — competing in the same conversation as [Dungeon Crawler Carl](/blog/2026-04-20-if-you-liked-dungeon-crawler-carl-read-these-next/) and *He Who Fights With Monsters* for system-apocalypse readers who want mechanical substance.
2. **Guardian of Aster Fall (North)** — competing with the Dakota Krout / Tao Wong tier of progression fantasy for crafting-loop readers. Different itch from Cradle, different itch from Primal Hunter, but the same caliber of patient world-building.
3. **Welcome to the Multiverse (Oswald solo)** — earlier in its arc than the above. The trajectory pattern says this is a series to watch rather than a finished argument.
4. **River of Fate / Wild Era (North)** — range plays. Worth tracking specifically because the same author hitting two adjacent subgenres at high quality is a rare data point.
...
- **Sean Oswald**: *Apocalypse BREAKER Book 1*. Co-authored entries are not always the right starting point, but in this case it's the strongest on-ramp into Oswald's voice. From there, the [reading order guide](/blog/2026-04-27-apocalypse-breaker-reading-order-all-4-books-ranked/) keeps you on track.
...
For deeper craft-side analysis, the LitRPG Critic has fuller spotlights on [Sean Oswald](https://litrpgcritic.com/blog/sean-oswald-author-spotlight-litrpg-apocalypse-done-right) and [David North](https://litrpgcritic.com/blog/david-north-author-spotlight-guardian-of-aster-fall-and-the-art-of-crafting-prog). For where their work fits in the rankings as the year moves on, this column is the place we'll keep updating. Browse the full LitRPG catalog and rating signals on [LitRPGTools.com](https://litrpgtools.com), and our [best new power fantasy releases](/blog/2026-04-22-best-new-power-fantasy-litrpg-releases-worth-reading-right-now/) is the natural next stop.
