---
title: "New Releases Roundup: Power Fantasy Picks Worth Your Time This Week"
description: "From dragon dungeon cores to cozy cultivation delivery runs, here are the new power fantasy and LitRPG releases making noise in the community right now."
date: "2026-06-29"
type: "new_releases"
author: "Fantasy Ranked Editorial"
tags: ["new releases", "LitRPG", "progression fantasy", "cultivation", "dungeon core", "isekai", "system apocalypse"]
featured: false
---
...
Felix Tang's **The Last Order: An Answer for the Heavenly Dao** (Myriad-Worlds Delivery Book 3) is the wildcard pick this week. [Cultivation fiction](https://litrpgcritic.com/blog/what-is-cultivation-fiction/) blended with a logistics-and-delivery premise sounds like a gimmick, but Tang has been consistently threading that needle — the Dao philosophy lands with actual weight, and the delivery framing creates a natural structure for cross-world encounters that keeps the cultivation grind from feeling repetitive. If you track xianxia-adjacent work from authors like J.F. Brink or David North's *River of Fate*, this series is worth folding into your rotation.

Finally, **Backstreet Evolutionist Book 1** by Anton Panarin is the new-reader entry point in this batch. The [system apocalypse](/rankings/best-system-apocalypse/) framing is familiar territory, but early reader feedback points to strong worldbuilding hooks and a protagonist whose evolution path stays coherent rather than sprawling. For readers coming off something like *Dungeon Crawler Carl* or Zogarth's *The Primal Hunter* and looking for the next street-level survival story with real teeth, this is a reasonable first stop. The fact that Book 4 also dropped simultaneously suggests the series has found its footing fast.

For a broader look at what's trending across [new releases](/new-releases/) in the genre right now, the community tracker at [LitRPGTools.com](https://litrpgtools.com) is the most reliable resource we've found for cutting through the noise. And if you want to benchmark any of these against the best the genre has produced, our [top power fantasy rankings](/rankings/top-power-fantasy-books/) are the place to start.
