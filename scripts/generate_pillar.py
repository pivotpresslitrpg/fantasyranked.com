...
PILLAR_TOPICS = [
    {
        'title': 'What is Cultivation Fiction? The Complete Guide to Xianxia and Cultivation Novels',
        'slug': 'what-is-cultivation-fiction',
        'description': 'What is cultivation fiction? A complete guide to xianxia, wuxia, and cultivation novels — their origins, defining features, best books to start with, and how they connect to progression fantasy.',
        'word_count': '2500-3000',
        'focus': 'Cultivation Fiction',
        'internal_links': [
        ...
        'faq_topics': [
            ...
            'What is the difference between xianxia, wuxia, and cultivation fiction?',
            'What are the best cultivation novels in English?',
            'How does cultivation fiction relate to LitRPG and progression fantasy?',
            'Where did cultivation fiction originate?',
...
2. Main sections (use ## H2 headings):
   ...
   - History and Origins (Chinese literary traditions to Western adaptations)
   - Key Subgenres (xianxia, wuxia, xuanhuan, English-original cultivation)
   - How It Differs From Related Genres (progression fantasy, LitRPG)
   - Why Readers Love It
   - 10 Best Cultivation Books to Start With (numbered list with brief descriptions)
...
- In the "10 Best Books" section, include both translated classics (Cradle, Reverend Insanity, A Will Eternal) and English-original cultivation works
